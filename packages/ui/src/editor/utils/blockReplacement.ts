...
export function replaceBlock(
  ...
  if (Array.isArray(replacement)) {
    ...
    const firstNodeSize = replacement[0].nodeSize;
...
export interface BlockCreator {
  ...
  heading: (schema: any, level: 1 | 2 | 3, content?: Fragment, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create list block with given type */
  listBlock: (schema: any, listType: 'bullet' | 'numbered' | 'task', content?: Fragment, checked?: boolean, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create blockquote */
  blockquote: (schema: any, content?: Fragment, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create callout */
  callout: (schema: any, type: 'info' | 'warning' | 'error' | 'success', content?: Fragment, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create code block */
  codeBlock: (schema: any, content?: string, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create toggle header (standalone, flat structure) */
  toggleBlock: (schema: any, content?: Fragment, preservedAttrs?: PreservedAttrs) => PMNode;
  /** Create paragraph */
  paragraph: (schema: any, content?: Fragment, preservedAttrs?: PreservedAttrs) => PMNode;
}
